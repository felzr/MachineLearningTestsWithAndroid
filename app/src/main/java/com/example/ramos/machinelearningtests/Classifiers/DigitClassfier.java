package com.example.ramos.machinelearningtests.Classifiers;
...
public class DigitClassfier {
    private static final String LOG_TAG = DigitClassfier.class.getSimpleName();
    ...
    public DigitClassfier(Activity activity) throws IOException {
    ...
    public DigitResult classify(Bitmap bitmap) {
        ...
        return new DigitResult(mResult[0], timeCost);
